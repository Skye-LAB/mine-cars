  ...
  <div class="row">
    ...
    <div class="card p-2 overflow-auto" style="min-height: 50vh;">
      ...
      <div class="row">
        ...
        <div class="d-grid gap-2" v-if="booking && booking.status == 1">
          <button class="btn btn-primary" type="button" @click="updateBooking(booking.id)">Return</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  setup() {
    ...
    const updateBooking = (id) => {
      store.dispatch("bookings/returnBooking", { id: id })
    }
